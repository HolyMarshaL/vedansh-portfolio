...
export default function HeroDynamicElements() {
  ...
  useEffect(() => {
    ...
    // Recurring — single meteor every 8-15s; sat/astro at 50% reduced rate
  ...
  }, [spawnMeteor, spawnSatellite, spawnPlanet, spawnAstronaut]);

  // Boost when cursor is idle (conservative)
  useEffect(() => {
